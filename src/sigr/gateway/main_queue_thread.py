#!/usr/bin/env python
from time import sleep  # ctime was F401
import json
import serial
import threading  # time was unused here
import queue
q = queue.Queue()
...
def Consumer():
    ...
    while count < 1000:
        count += 1
        # TODO: Unused variable, remove or use. # data = q.get()
        q.get()  # Keep the q.get() call
...
# import time # F401: 'time' imported but unused (sleep is directly imported)
# import threading # threading is already imported at the top
# import queue # queue is already imported at the top
# q = queue.Queue() # q is already defined at the top
